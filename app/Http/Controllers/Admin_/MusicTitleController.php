...
class MusicTitleController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'file.required' => 'MP3 File field is required!',
            'file1.required' => 'WAV Image field is required!',
        ...
        $music_titles->genre = $request['first_genre_name'].','.$request['second_genre_name'].','.$request['third_genre_name'];
