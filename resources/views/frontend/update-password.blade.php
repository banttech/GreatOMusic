        ...
        <div class="container">
            <div class="row">
                ...
                <div class="width mt-0">
                    <form class="mb-3" method="POST" action="{{ route('frontend.update.password') }}">
                        @csrf
                        <div class="mb-3">
                            <label for="password" class="form-label">New Password<span class="text-danger" style="font-size: 16px;">*</span></label>
                        ...
                        <div class="mb-3">
                            <label for="confirm_password" class="form-label">Confirm New Password<span class="text-danger" style="font-size: 16px;">*</span></label>
                            <input type="password" class="form-control" id="confirm_password" name="confirm_password" placeholder="Confirm New Password" value="{{ old('confirm_password') }}">
