    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 genreimg" style="width:100%">
                ...
                <div class="tab-content pt-0 px-0 px-sm-0 acctblscrolltop" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <div class="row d-flex align-items-center {{ $isExpired ? 'expired' : 'noexpired' }} {{ $isExpired ? 'acctblscroll' : 'acctblscrollnoexp' }}">
                            <div class="col-sm-1 pl-5 acctblplay-1">
                            ...
                            <div class="col-sm-3 pt-2 acctblplay-3">
                                <strong>{{ $music->title }}</strong>
                            </div>
                            <div class="col-sm-8 d-flex justify-content-center gap-6 acctblinfocls acctblplay-8">
                                <a><input type="button" class="btn " value="Info" style="background:#CC0066;color:white;border-radius:20px;padding:4px 20px 7px 20px; margin-top:2px;" onclick="showDetails('{{ $license->id }}')"></a>
                        ...
                        <hr class="acctblhrcls" style="margin-top:0px!important; margin-bottom:0px!important; border-top: 1px solid #833D3C;">
                        @endforeach
                    </div>
                </div>
            </div>
    ...
    <div class="section audioSection">
        <div class="row pt-3">
            <div class="col text-center py-2 music__player">
                ...
                <div style="width: 60%;" class="accmplayercls">
                    <p id="audioText">
