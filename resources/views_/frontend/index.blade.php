                ...
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <div class="row" style="padding-top:2px;">
                            ...
                            <div class="col-md-2 pt-2">
                                <?php $file = pathinfo($musicTitle->file, PATHINFO_FILENAME); ?>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="row text-center" style="padding:5px 10px 0 10px;">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('frontend.music.search') }}?q=&title=&artist={{ $artist->name }}&genre=&tempo=&version=" class="music_title_link">
                                    {{ $artist->name }}
                                </a>
                                <hr>
                            </div>
    ...
    <div class="row pt-3" style="background:#30343F">
        <div class="col text-center py-2 music__player">
            ...
            <?php 
                ...
                $featuredFile = isset($featuredMusicTitle->file) ? $featuredMusicTitle->file : '';
