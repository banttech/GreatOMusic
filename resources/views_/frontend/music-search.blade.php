                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('frontend.cart.add', ['id' => $music->id,'file' => $file, 'cart_item' => 0]) }}">
                                            <button class="btn-3" style="color: #fff; padding: 7px 18px!important; border: none; background: #cc0066;"> <img src="{{ asset('frontend-assets/image/whiteicon.png')}}" style="width: 16px; height:1ypx;padding-bottom: 2px;" alt="">
                                                CART
                                            </button>
                                        </a>
                                    </td>
