            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form action="{{ route('about.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-sm-10">
                    <img class="mt-2 mb-3" src="{{ url('admin-assets/images/'.$pagesabout->headerimg)}}" alt=" "
                     width="100%" height="200px" id="header_img" /> 
                    <input type="file" name="headerimg" value="{{$pagesabout->headerimg}}" class="form-control mb-2"/>
